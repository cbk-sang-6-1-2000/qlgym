...
if(isset($_POST['Hoten'])){
    ...
    // echo $idnv;
    // echo $_POST['id'];
    $qry = "INSERT INTO luong(id_nhanvien, Tongtien, Ngaytraluong, Ghichu) values ('$idnv','$tongtien','$ngaytt','$ghichu')";
...
<?php $page='suadichvu'; include '../includes/sidebar.php'?>
    <?php
        $id=$_GET['id'];
        $qry= "select * from nhanvien n left join luong l on n.id_nhanvien = l.id_nhanvien where n.id_nhanvien='$id'";
        $result=mysqli_query($con,$qry);
        ...
        <div class="widget-content nopadding">
          <form method="POST" class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" name="luong" value='<?php echo $row['luong']; ?>' required />
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" name="thuong" placeholder="Nhập tiền thưởng (nếu có)" />
              </div>
            </div>
