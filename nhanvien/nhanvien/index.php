        ...
        $result=mysqli_query($con,$qry);
          echo"<table class='table table-bordered table-hover'>
            ...
            echo"<tbody> 
                ...
                <td><div class='text-center'>".$row['congviec']."</div></td>
                ...
                <td><div class='text-center'><a href='xoa.php?id=".$row['id_nhanvien']."' style='color:#F66;'><i class='fas fa-trash'></i> Xóa</a></div></td>
