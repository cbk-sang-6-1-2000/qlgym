              ...
              <div class="controls">
                <select class="form-control" name="id_nhanvien" id="id_nhanvien">
                    ...
                    <?php
                        ...
                        $list = executeResult($sql);
                    foreach($list as $item){
                    echo '<option value="'.$item['id_nhanvien'].'">'.$item['Hoten'].'- '.$item['Giathue'].'đ</option>';
                    }
                    ?>
                  </select>
