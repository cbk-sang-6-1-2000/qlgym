    ...
    <div class="span6">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          ...
          <form action="xulyhethan.php" method="POST" class="form-horizontal">
            <div class="control-group">
              <label class="control-label">Họ và tên :</label>
              <div class="controls">
                <input type="text" class="span11" name="Hoten" value='<?php echo $row['Hoten']; ?>' />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Tài khoản :</label>
              <div class="controls">
                <input type="text" class="span11" name="Taikhoan" value='<?php echo $row['Taikhoan']; ?>' />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Mật khẩu :</label>
              <div class="controls">
                <input type="text"  class="span11" name="Matkhau" value='<?php echo $row['Matkhau']; ?>'  />
              </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="date" name="Ngaybd" class="span11" value='<?php echo $row['Ngaybd']; ?>' />
        ...
        <div class="widget-content nopadding">
          <div class="form-horizontal">
            <div class="control-group">
              <label for="normal" class="control-label">Thời gian: </label>
              <div class="controls">
      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <div class="form-horizontal">
            <div class="control-group">
              ...
              <div class="controls">
                <input type="number" id="mask-phone" name="Sdt" value='<?php echo $row['Sdt']; ?>' class="span8 mask text">
                </div>
            </div>
            <div class="control-group">
              <label class="control-label">Địa chỉ :</label>
              <div class="controls">
                <input type="text" class="span11" name="Diachi" value='<?php echo $row['Diachi']; ?>' />
              </div>
            </div>
          </div>
        ...
        <div class="widget-content nopadding">
          <div class="form-horizontal">
            ...
            <div class="control-group">
              <label for="normal" class="control-label">Dịch vụ: </label>
                <div class="controls">
                <select class="form-control" name="Dichvu" id="Dichvu">
                    ...
                    echo '<option value="'.$item['id'].'">'.$item['Tendv'].'</option>';
                    }
                    ?>
                  </select>
                </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <select class="form-control" name="id_nhanvien" id="id_nhanvien">
                    <option value="">Chọn</option>
                    <?php
                        $sql = 'select * from nhanvien where congviec = "Huấn luyện viên"';
                        $list = executeResult($sql);
                    foreach($list as $item){
                    echo '<option value="'.$item['id_nhanvien'].'">'.$item['Hoten'].'</option>';
                    }
                    ?>
                  </select>
            </div>
