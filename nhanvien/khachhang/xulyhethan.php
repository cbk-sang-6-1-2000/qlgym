...
if(isset($_POST['Hoten'])){
    ...
    $totalamount = $dv * $Kehoach;      
            $qry = "update khachhang set Hoten='$Hoten', Taikhoan='$Taikhoan',Ngaybd='$Ngaybd', Ngaykt = '$Ngaykt', Gioitinh='$Gioitinh', id='$Dichvu', id_nhanvien = '$id_nv', Tongtien='$totalamount', Kehoach='$Kehoach', Diachi='$Diachi', Sdt='$Sdt', Ngaykt = '$Ngaykt', Loinhac = '0' where user_id='$id'";
