...
<form role="form" action="index.php" method="POST">
    ...
    if($Kehoach1 == 12){
            ...
            $qry = "update khachhang set Hoten='$Hoten', Taikhoan='$Taikhoan', Gioitinh='$Gioitinh', Diachi='$Diachi', Sdt='$Sdt', ngaythue = '$Ngaybd1', ngayktthue = '$Ngaykt1',Matkhau = '$Matkhau', id_nhanvien = '$id_nhanvien' where user_id='$id'";
