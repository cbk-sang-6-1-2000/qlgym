...
<div id="content">
  ...
  <div class="container-fluid">
    ...
    <div class="row-fluid">
	  ...
	  <?php
      $search=$_POST['search'];
      $qry="SELECT k.user_id, k.Hoten, k.Sdt, k.Diachi, k.Kehoach,k.Taikhoan, k.Gioitinh, d.Tendv, k.Ngaybd, k.Ngaykt, k.Tongtien, k.Trangthai, DATEDIFF(k.Ngaykt, CURDATE()), IF(DATEDIFF(k.Ngaykt, CURDATE()) <= 0,'hết hạn','hoạt động') AS ngày FROM khachhang k JOIN Dichvu d on k.id = d.id where Hoten like '%$search%' or Taikhoan like '%$search%'";
      $cnt = 1;
        $result=mysqli_query($con,$qry);
          ...
          echo"<table class='table table-bordered table-hover'>
            ...
            echo"<tbody> 
                ...
                <td><button class='text-center' onclick='khach_hang_list(".$row['user_id'].")'>Xoá</button></td>
