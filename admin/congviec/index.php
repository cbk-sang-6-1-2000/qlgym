...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i>Trang chủ</a> <a href="#" class="current">Danh sách công việc</a> </div>
    <h1 class="text-center">Quản lý công việc<i class="fas fa-group"></i></h1>
  </div>
        ...
        $result=mysqli_query($con,$qry);
          echo"<table class='table table-bordered table-hover'>
            ...
            echo"<tbody> 
                ...
                <td><div class='text-center'><a href=''onclick='khach_hang_list(".$row['idCv'].")' style='color:#F66;'><i class='fas fa-trash'></i>Xoá</a></div></td>
                <td><div class='text-center'><a href='sua.php?id=".$row['idCv']."' style='color:#FFD700'><i class='fas fa-edit'></i>Sửa</a></div></td>
              </tbody>";
          $cnt++;  
        }
            ?>
