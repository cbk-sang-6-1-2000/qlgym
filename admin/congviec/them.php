...
if(isset($_POST['TenCV'])){
    ...
    $qry = "INSERT INTO congviec(TenCV,Tratien) values ('$TenCV','$Tratien')";
        ...
        <div class="widget-content nopadding">
          <form method="post" class="form-horizontal">
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" name="TenCV" placeholder="Nhập Tên công việc" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Tiền lương :</label>
              <div class="controls">
                <input type="text" class="span11" name="Tratien" placeholder="Nhập lương" />
              </div>
            </div>
