...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i>Trang chủ</a> <a href="#" class="current">Danh sách nhân viên</a> </div>
    <h1 class="text-center">Quản lý lương thưởng<i class="fas fa-group"></i></h1>
  </div>
          ...
          <table class='table table-bordered table-hover'>
              <thead>
                <tr>
                    ...
                    <th>Đã trả vào ngày?</th>
                </tr>
              </thead>
             <?php
                    $qry="SELECT nhanvien.Hoten, nhanvien.Sodienthoai, luong.Tienthuong, luong.Tongtien, luong.Ngaytraluong FROM nhanvien JOIN luong on nhanvien.id_nhanvien = luong.id_nhanvien";
           ...
           <tbody>               
                ...
                <td><div class='text-center'><?php echo $row['Sodienthoai']; ?></div></td>
                <td><div class='text-center'><?php echo $row['Tienthuong']; ?></div></td>
                <td><div class='text-center'><?php echo $row['Tongtien']; ?></div></td>
                <td><div class='text-center'><?php echo $row['Ngaytraluong']; ?></div></td>
