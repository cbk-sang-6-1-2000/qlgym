...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i>Trang chủ</a> <a href="#" class="tip-bottom">Quản lý thiết bị</a> <a href="#" class="current">Cập nhật thông tin</a> </div>
  <h1>Cập nhật</h1>
</div>
<form role="form" action="index.php" method="POST">
    <?php 
            ...
            $id = $_POST['id'];
            $id1 = $_POST['admin'];
            $qry = "update thongbao set user_id = '$id1', Noidung='$Noidung', Ngaydangbai ='$Thoigian' where id='$id'";
